                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount: dashboardProvider.categories.length,
                      itemBuilder: (context, index) => Row(
                        children: [
                          CategoryButton(
                            categoryName: dashboardProvider.categories[index],
                            isSelected:
                                (index ==
                                dashboardProvider.selectedCategoryIndex),
                            onTap: () =>
                                dashboardProvider.selectCategory(index),
                          ),
                          SizedBox(width: 4.w),
                        ],
                      ),
